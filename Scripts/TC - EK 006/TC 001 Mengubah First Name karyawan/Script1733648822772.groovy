...
WebUI.click(findTestObject('Edit Employee/inputFirstname'))

WebUI.sendKeys(findTestObject('Edit Employee/inputFirstname'), Keys.chord(Keys.CONTROL, 'a', Keys.DELETE))

WebUI.setText(findTestObject('Edit Employee/inputFirstname'), 'kafi')
