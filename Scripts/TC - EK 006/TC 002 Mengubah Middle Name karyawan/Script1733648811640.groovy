...
WebUI.click(findTestObject('Edit Employee/inputMiddlename'))

WebUI.sendKeys(findTestObject('Edit Employee/inputMiddlename'), Keys.chord(Keys.CONTROL, 'a', Keys.DELETE))

WebUI.setText(findTestObject('Edit Employee/inputMiddlename'), 'abdullah')

WebUI.click(findTestObject('Edit Employee/buttonSave'))
