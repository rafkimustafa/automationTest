...
WebUI.click(findTestObject('Edit Employee/inputEmployeeid'))

WebUI.sendKeys(findTestObject('Edit Employee/inputEmployeeid'), Keys.chord(Keys.CONTROL, 'a', Keys.DELETE))

WebUI.setText(findTestObject('Edit Employee/inputEmployeeid'), '970906')
