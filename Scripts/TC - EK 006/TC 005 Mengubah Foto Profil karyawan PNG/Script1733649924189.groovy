...
WebUI.setText(findTestObject('Search Employee/inputEmployeeid'), '970906')
...
WebUI.verifyMatch('970906', '970906', false)

WebUI.delay(2)

WebUI.click(findTestObject('Edit Employee/buttonEditemployee'))

WebUI.click(findTestObject('Edit Employee/navImage'))

WebUI.delay(2)

WebUI.click(findTestObject('Edit Employee/addImage'))

String filePath = 'C:\\Users\\rafki\\git\\automationTest\\Screenshots\\test_upload.png'
...
WebUI.click(findTestObject('Edit Employee/buttonSaveimage'))

WebUI.verifyElementPresent(findTestObject('Edit Employee/toasSuccess'), 0)
