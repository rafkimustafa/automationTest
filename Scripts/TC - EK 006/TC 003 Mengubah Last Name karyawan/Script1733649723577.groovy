...
WebUI.click(findTestObject('Edit Employee/inputLastname'))

WebUI.sendKeys(findTestObject('Edit Employee/inputLastname'), Keys.chord(Keys.CONTROL, 'a', Keys.DELETE))

WebUI.setText(findTestObject('Edit Employee/inputLastname'), 'rafki mustafa')
