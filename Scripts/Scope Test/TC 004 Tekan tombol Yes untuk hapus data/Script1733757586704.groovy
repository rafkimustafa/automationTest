...
WebUI.click(findTestObject('Delete Employee/buttonDelete'))

WebUI.verifyElementPresent(findTestObject('Delete Employee/alertConfirmdelete'), 0)

WebUI.delay(2)

WebUI.click(findTestObject('Delete Employee/buttonYesdelete'))

WebUI.verifyElementPresent(findTestObject('Delete Employee/toasSuccess'), 0)
