...
WebUI.setText(findTestObject('Search Employee/inputUsername'), 'rafki mustafa')
...
WebUI.click(findTestObject('Search Employee/buttonReset'))

WebUI.scrollToElement(findTestObject('Search Employee/tableEmployee'), 0)

WebUI.waitForElementPresent(findTestObject('Search Employee/tableEmployee'), 0)
